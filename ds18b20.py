...
# use this to config the raspi, in /boot/config.txt
# first tried this, dtoverlay=w1-gpio,gpiopin=4,pullup=on,extpullup=3
# then moved to this dtoverlay=w1-gpio,gpiopin=18,pullup=on,extpullup=8
